package com.ioter.clothesstrore.wdiget.cache;
...
import com.ioter.clothesstrore.common.util.VariableConstant;
 ...
 * 全局异常捕获
 */
public class ClothsStroreCaughtException implements UncaughtExceptionHandler
{
    private UncaughtExceptionHandler mDefaultUncaughtExceptionHandler;// 系统的异常捕获对象

    public ClothsStroreCaughtException()
    {
    ...
    public void uncaughtException(Thread thread, Throwable ex)
    {
        ...
        } else
        {
            ...
            intent.setComponent(
                    new ComponentName(VariableConstant.APP_PACKAGE_MAIN, "com.ioter.clothesstrore.video.floatUtil.EpcDetailActivity"));
