...
public class FixHeiLinearLayout extends LinearLayout
{
    private double wh_ratio=0.0;

    public FixHeiLinearLayout(Context context)
    {
        super(context);
        wh_ratio = 2.0;
    }

    public FixHeiLinearLayout(Context context, double mWh_ratio)
    {
        super(context);
    ...
    public FixHeiLinearLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public FixHeiLinearLayout(Context context, AttributeSet attrs, int defStyle) {
