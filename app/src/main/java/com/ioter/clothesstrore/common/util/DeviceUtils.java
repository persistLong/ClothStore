...
public class DeviceUtils
{
    ...
    {
        ActivityManager activityMgr = (ActivityManager) AppApplication.getApplication()
                .getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> runningApps = activityMgr.getRunningAppProcesses();
        if (runningApps != null)
        {
            for (ActivityManager.RunningAppProcessInfo info : runningApps)
            {
                ...
                {
                    if (VariableConstant.APP_PACKAGE_MAIN.equals(info.processName))
                    {
                        return true;
                    } else if ((VariableConstant.APP_PACKAGE_MAIN + ":fishbowl").equals(info.processName))
                    {
                        return false;
                    }
                }
